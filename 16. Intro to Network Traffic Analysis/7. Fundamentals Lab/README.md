...
@htb[/htb]$ tcpdump -i [interface name or #]
...
@htb[/htb]$ tcpdump -i [interface name or #] -vX
...
@htb[/htb]$ tcpdump -i [interface name or #] -nvw [/path/of/filename.pcap]
...
@htb[/htb]$ tcpdump -nnSXr [file/to/read.pcap]
