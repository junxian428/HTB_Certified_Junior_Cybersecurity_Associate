...
<img width="511" height="755" alt="image" src="https://github.com/user-attachments/assets/63b78370-ce88-470f-bde3-171fe92c3705" />
...
<img width="794" height="238" alt="image" src="https://github.com/user-attachments/assets/d1d59362-621e-4eac-985a-df1f483029fc" />
...
<table border="1" cellspacing="0" cellpadding="5">
  ...
  <tbody>
    ...
    <tr>
      <td>REG_LINK</td>
      <td>A null-terminated Unicode string containing the target path of a symbolic link created by calling the RegCreateKeyEx function with REG_OPTION_CREATE_LINK.</td>
    </tr>
    <tr>
      <td>REG_MULTI_SZ</td>
      <td>A sequence of null-terminated strings, terminated by an empty string (\0). Example: String1\0String2\0String3\0LastString\0\0. The first \0 terminates the first string, the second to last \0 terminates the last string, and the final \0 terminates the sequence. Note that the final terminator must be factored into the length of the string.</td>
    </tr>
    <tr>
      <td>REG_NONE</td>
...
<img width="790" height="233" alt="image" src="https://github.com/user-attachments/assets/0f9a8076-140b-4b23-acbe-c346cffd5708" />
...
<img width="797" height="473" alt="image" src="https://github.com/user-attachments/assets/0435475c-6a02-4324-9860-a8f24b4ca9d5" />

The user-specific registry hive (HKCU) is stored in the user folder (i.e., C:\Users\<USERNAME>\Ntuser.dat).

<img width="810" height="700" alt="image" src="https://github.com/user-attachments/assets/2813958f-6799-4365-9638-379f937f918e" />

<h3>Run and RunOnce Registry Keys</h3>
...
<img width="805" height="269" alt="image" src="https://github.com/user-attachments/assets/676a1185-2033-47d3-811f-e0516b9c3465" />
...
<img width="796" height="617" alt="image" src="https://github.com/user-attachments/assets/df90f98a-3ffb-4583-93fb-4b30d8843b8f" />
...
<img width="796" height="510" alt="image" src="https://github.com/user-attachments/assets/4d13bcbc-ed09-425f-a65d-471b5e4b99ae" />
...
<img width="804" height="514" alt="image" src="https://github.com/user-attachments/assets/bcb2dc74-0068-40cc-91b4-5ceee9860132" />
