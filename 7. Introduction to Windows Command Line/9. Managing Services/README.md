...
<h3>Query All Active Services</h3>
...
Returning to our scenario, we recently landed on a host and need to query the host and determine if Windows Defender is active. Let's give sc query a try.
 ...
 <h3>Querying for Windows Defender</h3>
...
<h3>Stopping an Elevated Service</h3>
...
<h3>Stopping an Elevated Service as Administrator</h3>
...
<h3>Finding the Print Spooler Service</h3>
...
<h3>Stopping the Print Spooler Service</h3>
...
<h3>Starting the Print Spooler Service</h3>
...
<h3>Disabling Windows Updates Using SC</h3>
...
<h3>Checking the State of the Required Services</h3>
...
<h3>Disabling Windows Update Service</h3>

C:\WINDOWS\system32> sc config wuauserv start= disabled

[SC] ChangeServiceConfig SUCCESS

<h3>Disabling Background Intelligent Transfer Service</h3>
...
<h3>Verifying Services are Disabled</h3>
...
<h3>Other Routes to Query Services</h3>
...
Note: It is important to be aware that the WMIC command-line utility is currently deprecated as of the current Windows version. As such, it is advised against relying upon using the utility in most situations. You can find further information regarding this change by following this link.
...
+ 0  What Windows executable will allow us to create, query, and modify services on a host?
sc
