...
1. Establishing secure communication channels, such as in the TLS protocol

2. Providing forward secrecy, which ensures that past communications cannot be revealed even if the private keys are compromised

3. Authenticating users and devices, such as in the Internet Key Exchange (IKE) protocol used in VPNs
